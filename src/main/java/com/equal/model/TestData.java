...
/****************************************Test Data*******************************/
	/*General*/
	public static final String Request_Id="20151222-000011";
	public static final String Program_Id="PROG-20151222-000008";
	public static final String Programs_Id="PROG-20151222-000010";
	public static final String Member_Id="C100";
	public static final String Member_Dob="02/05/1990";
	
	//test member
	
	/*Add a AddAppeal*/
	public static final String AddAppeal_MembID = "C101";
	public static final String AddAppeal_MembID1="C102";
	public static final String AddAppeal_Date = "12/14/2015";
	public static final String AddAppeal_UnitCount = "2";
	public static final String AddAppeal_DiagnosesSearchDescription ="Diabetes mellitus (250)";
	
	/*Add Plan Care And Close Plan Care */
	
	public static final String PlanCareProgram = "PROG-20151223-000024";
	
	/*AddProgram CostSaving*/
	
	public static final String ProgramCostSaving = "PROG-20151223-000026"; 
	
	/*Add Program Note*/
	
	public static final String AddProgramNote = "PROG-20151223-000028"; 
	
	/* Add RequestNote */
	
	public static final String AddRequestNote = "20151223-000059"; 
	
	/*AddPlanCareAndClosePlanCare*/
	
	public static final String AddPlanCareAndClosePlanCare_ProgramId = "PROG-20151223-000030";
	
	/* Add RequestRule AMF */
	
	public static final String RequestRuleAMF = "C103";
	
	/*Add RequestTask */
	
	public static final String AddRequestTask ="20151223-000060";
				
	/* All Notes And Notes Aggregate View */
	
	public static final String MemberIDtoNotes = "C104";
	
	/* Awf Rule Department Can Not Own Request */
	
	public static final String DepUserID = "C105";
	
	/* Awf Rule Department Can Own Request */
	
	public static final String DepUser_ID = "C106";
	
	/* Awf Rule Individual Can Not Own Request */
	
	public static final String IndividualMember_ID = "C107";
	
	/*Awf Rule Individual Can Own Request */
	
	public static final String IndividualMemberID = "C108";
	
	/* Behavioral Health Program */
	
	public static final String MemberName = "C109";
	
	/* Close Program */
	
	public static final String ProgramIDtoClose = "PROG-20151223-000032";
	
	/* Create Medical Behavioral Health Request */
	
	public static final String MemberIDtoCreateMBHR = "C110";
	
	/* Create Medical Health Management */
	
	public static final String MemberIDtoCMH = "C111";
	
	/* Create Providers */
	
	public static final String ReuestIDtoProvider = "20151223-000061";
	
	/* Create Providers Program */
	
	public static final String ProviderProgramID = "PROG-20151223-000034";
	

	/* Create Request Appeal Letter For Denied OutCome */
	
	public static final String RequestIDWithoutAppeal = "20151222-000051"; 
	public static final String RequestIDWithAppeal = "20151222-000052"; 
	
	/* Data Population In Standard Fields */
	
	public static final String DataPopulation = "C112";
	
	/* DischargeReopenRequest */
	
	public static final String DischargeReopenReuestID = "20151223-000062";
	
	/* Edit In patient Out patient Prior Medical Reference Request */
	
	public static final String EditIPandOP = "C113";
	
	/* Edit In patient Out Patient Referal Request */
	
	public static final String MemberIDtoEditOP = "C114";
	
	/* Edit Program Screening And Enrollment */
	
	public static final String MemberIDtoEditOPAndEnroll = "C115"; //Member should be added with a program //
	
	/* Extend In patient Medical Request */
	
	public static final String ExtednIPRequest = "C116";
	
	/* Medical And Behavioral Health Program */
	
	public static final String MedicalBHPID = "C117";
	
	/* Medical Behavioral Health Request */
	
	public static final String HealthRequestID = "C118";
	
	/* OPRequestWithMulitpleServices */
	
	public static final String OPRequestID = "C119";
	
	/* Program Attachment */
	
	public static final String ProgramID = "PROG-20151223-000036";
	
	/* Provider Contact */
	
	public static final String ProviderLName = "chin";
	
	/* Provider CustomField */
	
	public static final String CustomCode = "CF9";
	
	/* ReqRevQuestionnairesAndAaeRule */
	
	public static final String ReqRevID = "C119";
	
	/* Request Attachment */
	
	public static final String RequestAttachment = "C120";
	
	/* Request Movement */
	
	public static final String MemberIDtoMoveReq = "C121";
	public static final String MemberIDtoMoveReq1 = "C122";
	
	/* Request Outcome With CostSavings */
	
	public static final String MemberIDtoCostSavings = "C123";
	public static final String ProviderIDtoCostSavings = "Sarro";
	
	/* Search Add Diagnosis And Procedures */
	
	public static final String SearchMember = "C124";
	
	/* Searches */ 
	
	public static final String RequestId = "20151223-000062";
	public static final String MemberId = "C124";
	public static final String ProgramId="PROG-20151223-000036";
	public static final String ProviderName = "chin";
	
	/* ViewRequestSummaryInRequests*/
	
	public static final String ViewMemberID = "C125";
	
	/* Interaction Management */ 
	
	public static final String MemberFistName = "Chuck";
	public static final String MemberLastName = "Davis";
